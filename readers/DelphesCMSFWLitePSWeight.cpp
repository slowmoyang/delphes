                  ...
                  Bool_t firstEvent)
{
  ...
  // https://github.com/cms-sw/cmssw/blob/CMSSW_13_2_9/PhysicsTools/NanoAOD/plugins/GenWeightsTableProducer.cc#L498-L541
  // consider keepAllPSWeights_ == false;
...
int main(int argc, char *argv[])
{
  ...
  ExRootTreeBranch *branchEvent = 0, *branchWeight = 0, *branchPSWeight = 0;
  ...
  try
  {
    ...
    branchPSWeight = treeWriter->NewBranch("PSWeight", Weight::Class());

...
void CTagging::Process()
{
  ...
  while((jet = static_cast<Candidate *>(fItJetInputArray->Next())))
  {
    ...
    jet->CTag |= (gRandom->Uniform() <= formula->Eval(pt, eta, phi, e)) << fBitNumber;
    ...
    // apply an efficiency formula
    jet->CTagAlgo |= (gRandom->Uniform() <= formula->Eval(pt, eta, phi, e)) << fBitNumber;
    ...
    // apply an efficiency formula
    jet->CTagPhys |= (gRandom->Uniform() <= formula->Eval(pt, eta, phi, e)) << fBitNumber;
  }
}
